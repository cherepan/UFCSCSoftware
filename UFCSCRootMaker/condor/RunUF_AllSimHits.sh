...
python -i missing_layers.py  -m 1 -f ../ZMM_UF_10_05.root  -j Efficiency_MissingLayers_AllSimHits_UF_ME21 -c 0  -r 0 -k 1 2>&1 | tee LogUF_All
#python -i eff_csc.py  -m 1 -f ../ZMM_UF_10_05.root  -j Efficiency_AllSimHits_UF_ME21 -c 0  -r 0 -k 1 2>&1 | tee LogUF_All
